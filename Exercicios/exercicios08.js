// Aula 8 – Funções em JavaScript
// Exercícios de Fixação

// ----------------------------------------
// 1. Crie uma função `saudar` que recebe um nome como parâmetro e exibe:
// "Olá, [nome]! Seja bem-vindo(a)!"
// Se nenhum nome for fornecido, use "Visitante" como valor padrão.
...
// - Verifica se ambos são números finitos
// - Retorna a soma se válida ou NaN se algum parâmetro não for número
...
// - Recebe dois números e uma função callback (`operacao`)
// - Retorna o resultado da operação
// Teste com:
// - Callback nomeada que soma
...
// - Usa setTimeout para esperar `tempo` milissegundos
// - Depois imprime o `texto` no console
// Teste chamando a função 2 vezes com textos e tempos diferentes
// e observe a ordem de execução
// ----------------------------------------
